...
window.switchTab = function(targetId, btnElement) {
    ...
    // Bật active cho nút được bấm & content tương ứng
...
try {
    ...
    if (typeof firebase !== 'undefined') {
        ...
        function setupAuthListeners() {
            ...
            if (btnLogin) {
                btnLogin.onclick = () => { auth.signInWithPopup(provider).catch(err => showToast("Lỗi: " + err.message)); };
            }
...
if (btnSettings) {
    btnSettings.onclick = (e) => { e.preventDefault(); openSettingsModal(); };
}
...
if (btnTheme) {
    btnTheme.onclick = (e) => { e.preventDefault(); document.body.classList.toggle('dark-mode'); };
}
